...
from shape_function.components_shape_function.A import A, dA_dx, dA_dy, inverse_dif
from shape_function.components_shape_function.B import dB_dx, dB_dy, B
from shape_function.components_shape_function.p import p, dp_dx, dp_dy

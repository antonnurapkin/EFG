...
B = 1  # Размер пластины в направлении оси Х
R0 = A / 20  # Радиус отверстия


'''ПАРАМЕТРЫ АППРОКСИМАЦИИ'''
NODES_NUMBER = 4
CELLS = NODES_NUMBER - 1  # Сетка для интегрирования
FI_DELTA = np.pi / (2 * (CELLS * 2))  # Шаг угла для разбиения

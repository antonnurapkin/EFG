...
from helpers import find_nearest_nodes, N
from integration_points import create_integration_points_bound
from exact_solution import u_radial


def q_global(nodes_coords, rows, y_value=False, y_bound=False):
    # Правая вертикальная граница, u = 0
    integration_points_bottom = create_integration_points_bound(nodes_coords, y_value=y_value, y_bound=y_bound)
